...
class Weather extends Component {
  ...
  getLocations = (city, country, countryNameError) => {
    if (country) {
      ...
      this.setState({
        badCountryNameError: countryNameError,
  ...
  // delayState = function () {
  //   setTimeout(() => {
  //     this.setState({ badCountryNameError: undefined });
  //   }, 3000);
  // }

  fetchWeather = async (city, country) => {
    try {
      //console.log(country, (country !== "no country"))
      const api_call = (country && country !== "no country") ? await fetch(`https://api.openweathermap.org/data/2.5/forecast?q=${city},${country}&units=metric&APPID=${API_KEY}`) : await fetch(`https://api.openweathermap.org/data/2.5/forecast?q=${city}&units=metric&APPID=${API_KEY}`);
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    //console.log('App componentDidUpdate', this.state.badCountryNameError, this.state.displayComponent);
      ...
      <div className="weather" id="weather">
        <div className="weather-wrapper-all">
          ...
          <WeatherHead
            ...
            badCountryNameError={this.state.badCountryNameError}
