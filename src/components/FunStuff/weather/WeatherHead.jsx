...
function WeatherHead(props) {
  ...
  } else if (props.incorrectCountryNameError) {
    return (
      <div role="alert" className="error">{props.incorrectCountryNameError}</div>
    );
  } else {
    return (
      //   <div className="weather-display-wrapper.display">
